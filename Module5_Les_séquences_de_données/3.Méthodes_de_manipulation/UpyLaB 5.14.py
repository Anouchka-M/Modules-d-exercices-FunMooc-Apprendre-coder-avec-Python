...
et mot_2 comme le nombre minimum de fois où il faut modifier une lettre de mot_1 pour obtenir mot_2, sans changer leur
place (distance de Hamming).
...
print(distance_mots("chien", "niche")) #5